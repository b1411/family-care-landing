  ...
  <div class="hp-page">
    ...
    <div class="hp-hero">
      <div>
        ...
        <p class="hp-hero-sub">{{ appData.children[0]!.first_name }} · {{ entries.length }} записей</p>
      </div>
...
const passport = reactive({ blood_type: appData.children[0]?.blood_type ?? 'N/A', allergies: 1, chronic: 0 })
