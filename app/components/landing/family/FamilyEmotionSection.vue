    ...
    <div class="landing-container">
      <div class="emotion-header" data-reveal="fade-up">
        ...
        <p class="emotion-sub t-lead">
          4&nbsp;типичные ситуации — и&nbsp;как UMAI закрывает каждую из&nbsp;них в&nbsp;одно нажатие.
        </p>
      </div>
...
const pains = reactive<Pain[]>([
  {
    ...
    solution: 'Все анализы — в одном месте. Одно нажатие → ОАК за 2 секунды.',
    checked: false,
  },
  {
    id: 'p2',
    ...
    solution: 'Национальный календарь РК встроен. Следующая прививка с датой и партией.',
    checked: false,
  },
  {
    id: 'p3',
