...
const modules = [
  {
    ...
    desc: 'Мама, папа, ребёнок — каждый со своим профилем. Пригласите второго родителя и управляйте доступом.',
    features: ['Профили всех членов семьи', 'Приглашение второго родителя', 'Управление доступом'],
  ...
  },
  {
    ...
    title: 'Умная запись',
    shortName: 'Визиты',
    headline: 'Запись на приём в пару нажатий',
  ...
  },
  {
    ...
    shortName: 'Документы',
    headline: 'Архив, который не теряется',
  ...
  },
  {
    ...
    desc: 'Уведомления в нужное время. Подтверждение приёма в одно нажатие. Видна статистика приёма.',
    features: ['Уведомление в нужное время', 'Подтверждение в одно нажатие', 'Контроль приёма'],
    iconBg: 'var(--color-secondary-light)',
    iconColor: 'var(--color-secondary)',
    phoneTime: '08:00',
  },
  {
    ...
    desc: 'По национальному календарю РК. Напоминания за 3 дня. Полная история вакцинаций.',
    features: ['Национальный календарь РК', 'Напоминания заранее', 'История вакцинаций'],
    iconBg: '#FEF3C7',
    iconColor: '#92400E',
    phoneTime: '11:00',
  },
  {
    ...
    features: ['Персональный координатор', 'Помощь при пропусках', 'Приветственный звонок при подключении'],
    iconBg: 'var(--color-primary-light)',
    iconColor: 'var(--color-primary)',
    phoneTime: '16:00',
  },
...
const PhoneNotifications = () => h('div', { class: 'phone-list' }, [
  h('div', { class: 'phone-notif' }, [
    h('span', '💊'),
    h('div', [h('strong', 'Время витамина D'), h('span', '08:00 · уведомление')]),
  ]),
  h('div', { class: 'phone-notif' }, [
    h('span', '🏥'),
  ...
  h('div', { class: 'phone-notif' }, [
    h('span', '💉'),
    h('div', [h('strong', 'АКДС через 3 дня'), h('span', '15:00 · уведомление')]),
  ]),
])
