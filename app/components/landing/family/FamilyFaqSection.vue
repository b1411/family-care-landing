...
const faqs = [
  {
    q: 'Это бесплатно?',
    a: 'Приложение предоставляется вашей клиникой как часть сервиса сопровождения. Для семей это бесплатно — никаких скрытых платежей.',
  },
  {
    q: 'Как получить доступ?',
    a: 'Скажите координатору вашей клиники. Вам создадут аккаунт и отправят ссылку для входа.',
  },
  {
    q: 'Клиника ещё не подключена — что делать?',
    a: 'Расскажите вашей клинике о нас — мы свяжемся с ними и предложим пилотный запуск. Оставьте заявку внизу страницы.',
  },
  {
    q: 'Работает без интернета?',
    a: 'Да. Маршрут, назначения и документы доступны без интернета. Данные синхронизируются при подключении.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да. Пригласите второго родителя или близкого с доступом «просмотр» или полным.',
  },
]
</script>
