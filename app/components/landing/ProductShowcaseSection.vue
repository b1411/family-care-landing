...
const panels = [
  ...
  },
  {
    ...
    items: [
      { icon: 'lucide:alert-triangle', label: 'Айгерим К. — пропустила 2 визита', meta: 'Беременность, 28 нед.', badge: 'Срочно', color: '#D4727C', callout: 'Красный флаг — приоритет №1' },
      { icon: 'lucide:clock', label: 'Дана М. — прививка просрочена', meta: 'Ребёнок, 4 мес.', badge: 'Просрочено', color: '#E9C46A', callout: 'Автоматическое отслеживание просроченных' },
      { icon: 'lucide:check-circle', label: 'Асель Т. — маршрут в норме', meta: 'Ребёнок, 8 мес.', badge: '94%', color: '#7CB8D4', callout: 'Соблюдение назначений в реальном времени' },
      { icon: 'lucide:check-circle', label: 'Мадина С. — все визиты', meta: 'Беременность, 36 нед.', badge: '100%', color: '#7CB8D4', callout: 'Полный контроль выполнения маршрута' },
    ],
  },
  {
    device: 'device-desktop',
    ...
    description: 'Руководитель видит цифры: удержание семей, LTV, конверсия из беременности в педиатрию. Когортный анализ в реальном времени.',
    features: [
      'Удержание по когортам: месяц → квартал → год',
      'Конверсия: беременность → роды → педиатрия',
      'Revenue на семью и LTV',
      'NPS и engagement по модулям',
    ],
    items: [
      { icon: 'lucide:users', label: 'Активных семей', meta: 'За текущий месяц', badge: '847', color: '#8B7EC8', callout: 'Когортный трекинг в реальном времени' },
      { icon: 'lucide:trending-up', label: 'Удержание', meta: 'Когорта янв-2026', badge: '87%', color: '#7CB8D4', callout: 'Удержание по когортам: месяц → год' },
      { icon: 'lucide:arrow-right-left', label: 'Конверсия в педиатрию', meta: 'После родов', badge: '73%', color: '#D47EA5', callout: 'Конверсия из беременности в педиатрию' },
      { icon: 'lucide:dollar-sign', label: 'LTV на семью', meta: 'Средний за 2 года', badge: '×4.2', color: '#E9C46A', callout: 'LTV × 4.2 vs без платформы' },
    ],
  },
]
