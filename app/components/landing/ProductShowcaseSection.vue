...
const panels = [
  ...
  },
  {
    ...
    items: [
      { icon: 'lucide:alert-triangle', label: 'Айгерим К. — пропущено 2 визита', meta: 'Беременность, 28 нед.', badge: 'Срочно', color: '#D4727C', callout: 'Красный флаг — приоритет №1' },
      { icon: 'lucide:clock', label: 'Данияр Б. — прививка просрочена', meta: 'Ребёнок, 4 мес.', badge: 'Просрочено', color: '#E9C46A', callout: 'Автоматическое отслеживание просроченных' },
      { icon: 'lucide:check-circle', label: 'Амина Ж. — маршрут в норме', meta: 'Ребёнок, 8 мес.', badge: 'В норме', color: '#7CB8D4', callout: 'Соблюдение назначений в реальном времени' },
      { icon: 'lucide:check-circle', label: 'Нурай С. — все визиты', meta: 'Беременность, 36 нед.', badge: '✓', color: '#7CB8D4', callout: 'Полный контроль выполнения маршрута' },
    ],
  },
  {
    device: 'device-desktop',
