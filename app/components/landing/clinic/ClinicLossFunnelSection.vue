...
const insights = [
  ...
  },
  {
    ...
    desc: 'Каждый уход — это потерянные визиты, анализы, вакцинации и долгосрочный контакт с семьёй.',
    color: 'var(--color-warning)',
  },
  {
    icon: 'lucide:target',
    title: 'Возможность роста',
    desc: 'Системное сопровождение кратно увеличивает удержание — без привлечения новых пациентов.',
