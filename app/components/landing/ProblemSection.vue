...
const problemItems = [
  ...
  },
  {
    ...
    title: 'Руководитель видит отчёт, когда уже поздно',
    desc: 'Семья ушла в другую клинику три месяца назад. В квартальном отчёте это станет видно — если вообще станет.'
  },
]
